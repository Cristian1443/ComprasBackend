-- ============================================================
-- MIGRACIÓN: 10_update_view_gerencia.sql
-- Incluye gerencia_id en la vista v_solicitudes_resumen
-- ============================================================
...
SELECT
    ...
    s.gerencia_id, -- CAMBIO: Incluido para filtrado en panel de gerente
