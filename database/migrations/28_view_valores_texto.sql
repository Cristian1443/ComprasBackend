-- 28_view_valores_texto.sql
-- Incluye los valores monetarios "texto" (original digitado por el usuario)
-- en la vista de resumen, para que los listados muestren exactamente
-- lo que se escribió, sin reformateos ni conversiones.
