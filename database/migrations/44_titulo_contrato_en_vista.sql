-- 44_titulo_contrato_en_vista.sql
-- v_solicitudes_resumen no exponía titulo_contrato, por lo que la Bandeja
-- de Aprobaciones del gerente (y cualquier otra vista que dependa de esta
-- vista) siempre caía al fallback "objeto" en vez de mostrar el título
