-- ============================================================
-- MIGRACIÓN: 09_campos_contratacion_directa.sql
-- Agrega soporte para Fecha Comité, Modalidad de Selección y Justificación CD
-- ============================================================

ALTER TABLE solicitudes 
ADD COLUMN IF NOT EXISTS fecha_comite DATE,
ADD COLUMN IF NOT EXISTS modalidad_seleccion VARCHAR(255),
ADD COLUMN IF NOT EXISTS justificacion_cd TEXT;
